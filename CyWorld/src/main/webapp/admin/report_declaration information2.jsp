...
<head>
    ...
    <link rel="stylesheet" href="./admin_css/report_declaration information2.css?v=20251202E">
...
이 페이지는 관리자 계정입니다.
    ...
    <div class="declaration-panel-container">
            ...
            <div class="declaration-content-container">
                ...
                <div class="report-details-grid">
                    ...
                    <div class="report-description-box">
                  		법항 1조1항 협박성죄에 해당하여 법적검토를 위한 추가 시간이 필요로 인한 검토
                    </div>
        ...
        <div class="action-buttons-area">
            <button class="action-btn status-change-btn2">검토중</button>
            <button class="action-btn status-change-btn1">처리완료</button>
