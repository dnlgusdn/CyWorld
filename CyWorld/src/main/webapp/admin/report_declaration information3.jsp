...
<head>
    ...
    <link rel="stylesheet" href="./admin_css/report_declaration information3.css?v=20251202E">
...
이 페이지는 관리자 계정입니다.
    ...
    <div class="declaration-panel-container">
        ...
        <div class="declaration-header-view">
            ...
            <div class="status-badge">검토중</div>
        </div>
            ...
            <div class="declaration-content-container">
                ...
                <div class="report-details-grid">
                    ...
                    <div class="report-description-box">
                  		법항 1조1항 협박성죄에 해당하며 중대한 과실로 인정되어 영구정지처리 
                    </div>
