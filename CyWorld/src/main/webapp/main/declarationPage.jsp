...
<head>
    ...
    <!-- CSS 연결 -->
    <link rel="stylesheet" href="./main_css/declarationPage.css">
...
아 그만살고 싶다~ 
                        ...
                        <div class="left-buttons">
                            ...
                            <button class="left-btn"><a href="MainProfile.jsp">취소</a></button>
                        </div>
    ...
    <div class="report-popup-overlay">
        <div class="report-popup-box">
            <div class="report-popup-header">
                <img src="../img/admin.png" class="report-avatar"> 
                <div class="report-text-block">
                    **허위 신고 시 제재 될 수 있으며,**<br>
                    신고자도 대화내용이 제재사유에<br>
                    해당하는 경우 제재 될 수 있습니다.
                </div>
            </div>
            
            <div class="report-row report-category-row">
                <div class="report-label">신고 카테고리</div>
                <div class="report-input-group">
                    <div class="report-select-wrapper category-select">
                        <select class="report-category-select">
                            <option value="" disabled selected>선택하세요</option>
                            <option value="1">1. 게시판</option>
                            <option value="2">2. 쪽지</option>
                            <option value="3">3. 프로필</option>
                        </select>
                ...
                <div class="report-input-group">
                    <div class="report-select-wrapper">
                        <select class="report-reason-select">
                            <option value="" disabled selected>선택하세요</option>
                            <option value="1">1. 성적인 콘텐츠</option>
                            <option value="2">2. 폭력적 또는 혐오스러운 콘텐츠</option>
                            <option value="3">3. 증오 또는 악의적인 괴롭힘</option>
                            <option value="4">4. 명예훼손</option>
                        </select>
                        <i class="fas fa-caret-down select-arrow"></i>
                    </div>
                </div>
            ...
            <div class="report-row">
                <div class="report-label">신고상황 설명</div>
                <textarea class="report-description-textarea"></textarea>
            </div>

        		<div class="report-submit-row">
    			<button class="report-submit-btn">확인</button>
			</div>
